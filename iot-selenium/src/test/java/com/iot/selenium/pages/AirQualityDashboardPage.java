...
public class AirQualityDashboardPage extends BasePage {
  ...
  public boolean isAirQualityNavCardVisible() {
    return driver.findElements(AIR_QUALITY_NAV_CARD).stream()
  ...
  public AirQualityDashboardPage selectLocation(String value) {
  ...
  public AirQualityDashboardPage selectSort(String value) {
    return selectCustomOption(SORT_SELECT, value);
  }

  public AirQualityDashboardPage selectPageSize(String value) {
    return selectCustomOption(PAGE_SIZE_SELECT, value);
  }

  public AirQualityDashboardPage clickApplyFilters() {
    click(APPLY_FILTERS);
    waitForAngular();
    return this;
  }

  public AirQualityDashboardPage clickResetFilters() {
    click(RESET_FILTERS);
    waitForAngular();
    return this;
  }
  ...
  public AirQualityDashboardPage waitForLoadingToFinish() {
  ...
  public AirQualityDashboardPage waitForResultsReady() {
  ...
  public AirQualityDashboardPage clickNextPage() {
    click(NEXT_PAGE);
    return waitForResultsReady();
  }

  public AirQualityDashboardPage clickPrevPage() {
    click(PREV_PAGE);
    return waitForResultsReady();
  }

  public AirQualityDashboardPage clickFirstPage() {
    click(FIRST_PAGE);
    return waitForResultsReady();
  }

  public AirQualityDashboardPage clickLastPage() {
    click(LAST_PAGE);
    return waitForResultsReady();
  }
  ...
  public AirQualityDashboardPage waitForAlertBanner() {
    waitForVisible(ALERT_BANNER);
    return this;
  }

  public AirQualityDashboardPage dismissAlertBanner() {
  ...
  public AirQualityDashboardPage dismissAllAlertBanners() {
  ...
  public AirQualityDashboardPage clickAnalyticsToggle() {
...
*/
  ...
  public AirQualityDashboardPage waitForFilterPanelExpanded() {
    new WebDriverWait(driver, Duration.ofSeconds(5))
      .until(d -> !isFilterPanelCollapsed());
    return this;
  }

  public AirQualityDashboardPage waitForFilterPanelCollapsed() {
    new WebDriverWait(driver, Duration.ofSeconds(5))
      .until(d -> isFilterPanelCollapsed());
    return this;
  }
  ...
  private AirQualityDashboardPage selectCustomOption(By triggerLocator, String value) {
